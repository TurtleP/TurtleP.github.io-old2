...
- Use proper matrices instead of "fake" matrices
- Switch from mpg123 to dr_mp3 for mp3 audio files
- Implemented flac support via dr_flac
  - LÖVE already had flac support, but I'm reusing the same library version from their commit
