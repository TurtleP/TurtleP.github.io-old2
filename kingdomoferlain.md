...
If you'd like to read some of the story so far, download the prologue and first chapters; both come in one document either as a PDF or ePub.
Note: There's much more than this written. It's just a sample.

<p align="center" style="vertical-align: center">
	<a href="/docs/KingdomOfErlain_Sample.pdf"><i class="fa fa-2x fa-file-pdf-o"></i></a>
	<a href="/docs/KingdomOfErlain_Sample.epub"><i style="padding-left: 32px" class="fa fa-2x fa-book"></i></a>
</p>
